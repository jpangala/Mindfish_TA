    ...
    <thead class="thead-dark">
        ...
        foreach($ikan as $katalog) : ?>
            <tr>
                ...
                <td class="align-middle"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_ikan"><i class="fas fa-edit"></i></button>
                ...
                <button class="btn btn-primary" style="border: 1px;" data-toggle="modal" data-target="#gambar_ikan<?php echo $katalog->id ?>">Gambar Ikan <i class="fas fa-file"></i></button></td>
