...
class data_penjualan extends CI_Controller{
    ...
    public function hapus_penjualan($no_transaksi)
    {
            ...
            $this->model_penjualan->hapus_data($where, 'transaksi');
            $this->session->set_flashdata('message', 'Data penjualan berhasil dihapus');
            $this->session->set_flashdata('icon', 'success');
            redirect('admin/data_penjualan');
    }
    public function batal_penjualan($no_transaksi)
    {
            $where = array(
                'no_transaksi' => $no_transaksi
            );

            foreach ($this->model_penjualan->hapus_stok_penjualan('transaksi',$where)->result_array() as $items){
                $where2 = array(
    ...
    public function status_berhasil($no_transaksi)
    {
            $data = array(
    ...
    public function status_packing($no_transaksi)
    {
            $data = array(
    ...
    public function status_pengiriman($no_transaksi)
    {
            $data = array(
    ...
    public function status_selesai($no_transaksi)
    {
            $data = array(
                'status' => 'Selesai'
            );
